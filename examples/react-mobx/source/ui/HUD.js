...
export default inject(({application: {renderer, highScores}, game: {level, score}}) => ({level, renderer, score, topScore: highScores.length > 0 ? highScores[0].score : 0}))(observer(HUD))
