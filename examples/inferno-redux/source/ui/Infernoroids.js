...
const Infernoroids = ({renderer, screen, shipCount, saveScore, showMainMenu, startGame}) => (
  <div>
    <Audio />
...
export default connect(({application:{renderer, screen}, game:{shipCount}}) => ({renderer, screen, shipCount}))(Infernoroids)
